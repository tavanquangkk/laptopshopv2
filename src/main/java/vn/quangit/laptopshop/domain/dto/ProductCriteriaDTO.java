...
public class ProductCriteriaDTO {
            ...
            public ProductCriteriaDTO(Optional<String> page, Optional<List<String>> factory,
                    Optional<List<String>> target, Optional<List<String>> price, Optional<String> sort) {
                this.page = page;
