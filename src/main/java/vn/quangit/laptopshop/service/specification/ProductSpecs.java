...
public class ProductSpecs {
    ...
    // criteriaBuilder.between(root.get(Product_.PRICE), startVl, endVl);
    // }
    ...
    // public static Specification queryByFactoryNameList(List<String>
    // factoryNameList){
    // return (root,query,criteriaBuilder) ->
    // root.get(Product_.FACTORY).in(factoryNameList);
