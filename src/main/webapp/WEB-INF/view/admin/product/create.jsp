                                            ...
                                            <div class="mx-auto  col-md-6 col-12">
                                                ...
                                                <form:form action="/admin/product/create" method="post"
                                                    ...
                                                    <div class="col-12  mb-3 ">
                                                        <label for="floatingTextarea" class="form-label">Detail
                                                            description:</label>
                                                        <form:textarea class="form-control" id="floatingTextarea"
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col">
                                                            ...
                                                            <form:select class="form-select" path="target">
                                                                ...
                                                                <form:option value="Relax">Relax</form:option>
